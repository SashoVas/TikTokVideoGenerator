...
class SubtitlesGenerator:
    ...
    def create_image_with_text(self, text, output_path='images/output_image.png', font_style="arial.ttf", transparent=False):
        # Initialize ImageDraw to determine text size
        # You may need to adjust the font path
        font = ImageFont.truetype(font_style, self.font_size)
